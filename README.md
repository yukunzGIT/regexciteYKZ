...
You can install the development version of regexciteYKZ from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("yukunzGIT/regexciteYKZ")
```
...
That’s exactly what `regexciteYKZ::str_split_one()` does.

``` r
library(regexciteYKZ)
